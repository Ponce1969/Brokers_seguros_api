...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_tipos_documento_id"), "tipos_documento", ["id"], unique=False
    )
    op.create_table(
        "tipos_de_seguros",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_clientes_numero_cliente"), "clientes", ["numero_cliente"], unique=True
    )
    op.create_index(
        op.f("ix_clientes_numero_documento"),
        "clientes",
        ["numero_documento"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_movimientos_vigencias_id"),
        "movimientos_vigencias",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_movimientos_vigencias_id"), table_name="movimientos_vigencias"
    )
