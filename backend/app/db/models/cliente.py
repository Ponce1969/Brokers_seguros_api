...
class Cliente(Base):
    ...
    tipo_documento_id = Column(Integer, ForeignKey("tipos_documento.id"), nullable=False)  # Relación con tabla auxiliar
    ...
    corredores_asociados = relationship("ClienteCorredor", back_populates="cliente_rel")  # Relación con la tabla intermedia  